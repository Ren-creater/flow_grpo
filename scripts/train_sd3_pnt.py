...
from models.stable_diffusion_3.modeling_sd3_pnt import SD3PredictNextTimeStepModel
...
def toCuda(pipeline, accelerator):
...
def main(_):
    ...
    pipeline = SD3PredictNextTimeStepModel(pretrained_model_name_or_path=config.pretrained.model, torch_dtype=torch.float32)
    from safetensors.torch import load_file
    ckpt = load_file(config.sd3_checkpoint_path)
